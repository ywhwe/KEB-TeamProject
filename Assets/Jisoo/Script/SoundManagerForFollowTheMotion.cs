...
public class SoundManagerForFollowTheMotion : MonoBehaviour
{
    public static SoundManagerForFollowTheMotion instance;
    ...
    private Queue<AudioNodeFTM> soundPool = new();
    ...
    {
        var audioNode = Instantiate(soundNodePrefab, transform).GetComponent<AudioNodeFTM>();
    ...
    public void SetNode(AudioNodeFTM node)
    {
...
[Serializable]
public class AudioDataForFollowTheMotion
{
    public string key;
